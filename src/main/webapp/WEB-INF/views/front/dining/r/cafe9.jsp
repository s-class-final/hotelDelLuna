		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/cafe9/cafe9_main1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/cafe9/cafe9_main2.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
                ...
                <p class="colorEmp pt15i">* Café 9은 카지노 고객 전용 다이닝 시설입니다.</p>
            </div>
            ...
            <div class="detailInfo">
                ...
                <p class="colorEmp pt15i">* Breaktime (Cleaning): 03:00~04:00 / 16:00~17:00 </p>
            </div>
            <div class="cautionBox type2">
                <h2>안내사항</h2>
                <ul class="dotList">
                    
                    <li>Point 멤버십 고객 : 멤버십 카드와 함께 식사권 제시 또는 현금, 신용카드 결제 가능</li>                    
                    <li>Club 멤버십 고객 : 멤버십 카드 제시</li>
                </ul>
            </div>
        </div>
                ...
                <div class="termArea">
                    <div>
                        ...
                        <div class="termTxt" tabindex="0">
                            <p>델루나는 귀하의 개인정보를 소중하게 생각하며, 서비스제공을 위해 개인정보보호법 제 15조 및 제22조에 따라 귀하의 동의를 받고자 합니다.<br />
<br />
[개인정보 수집 및 이용 동의]<br />
