		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/raku/img_raku1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/raku/img_raku2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/raku/img_raku3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/raku/img_raku4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/raku/img_raku5.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/raku/img_raku6.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/raku/img_raku7.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
				<h2>Raku</h2>
				<p class="subTit">모던한 분위기에서 즐기는 트렌디한 일식의 진수</p>
				<p class="text">모던하고 트렌디한 분위기에서 일식을 즐길 수 있는 라쿠는 강렬한 색채의 포인트 인테리어를 입힌 일식 파인다이닝 레스토랑으로 다양한 장르의 일식을 창의적으로 재해석한 메뉴를 합리적인 가격에 즐길 수 있습니다.</p>
