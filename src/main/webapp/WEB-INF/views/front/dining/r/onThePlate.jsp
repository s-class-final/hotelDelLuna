		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/onThePlate/img_onThePlate1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/onThePlate/img_onThePlate2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/onThePlate/img_onThePlate3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/onThePlate/img_onThePlate4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/onThePlate/img_onThePlate5.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/onThePlate/img_onThePlate6.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
					...
					<dl>
						...
						<dd>
							<dl>
								...
								<dd>
									일~금 18:00~22:00<br />
									토요일 (1부)<br />17:00~19:00 <br />
									토요일 (2부)<br />20:00~22:00 </span><br />
								</dd>
							</dl>
							<p style="line-height:1.3"><span class="smallText">※쾌적한 이용을 위하여 조식뷔페 입장은 10:00까지로 제한됩니다.</span></p>
						</dd>
					</dl>
					<dl>
						<dt>좌석수</dt>
						<dd>140석 (프라이빗 룸 2실 / 각 8인석)</dd>
					</dl>
					<dl>
						<dt>위치</dt>
			...
			<div class="detailInfo" style="padding-bottom:60px;">
				<h3>요금 안내</h3>
				<table class="priceList">
					...
					<thead>
						<tr>
							...
							<th scope="col">주중(월~금요일)</th>
							<th scope="col">주말(토,일요일)</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="tbg" rowspan="2">Breakfast</td>
							<td>성인</td>
							<td>50,000원</td>
							<td>50,000원</td>
						</tr>
						...
						<tr>
							<td class="tbg" rowspan="2">Lunch</td>
							<td>성인</td>
							<td>75,000원</td>
							<td>95,000원</td>
						</tr>
						...
						<tr>
							<td class="tbg" rowspan="2">Dinner</td>
							<td>성인</td>
							<td>95,000원</td>
							<td>105,000원</td>
						</tr>
				...
				<a href="javascript:jsDownImg('17037');" class="tbLink_menu1">쇠고기 유통이력 식별번호 보기</a>
				
				
				<a href="javascript:jsDownImg('17038');" class="tbLink_menu1 tbLink_menu2">돼지고기 유통이력 식별번호 보기</a>
			...
			<!-- <div class="detailInfo">
				...
				<section class="jsSwiperMotion">
					<div class="swiperWrap" data-show="2">
						<ul>
							<li>
								<p class="img"><img src="/pcPub/static/images/hotalParadise/img_onThePlate_station1.jpg" alt="" /></p>
								<h4>New York Style Station</h4>
								<p class="text">푸짐하게 준비한 New York Style의 Brunch와 Grill Station으로 구성되어 있습니다.</p>
							</li>
							<li>
								<p class="img"><img src="/pcPub/static/images/hotalParadise/img_onThePlate_station2.jpg" alt="" /></p>
								<h4>Mediterranean Station</h4>
								<p class="text">지중해식 Fresh&amp;Healthy 스타일로 식재료 본연의 맛과 향을 살리고 신선함과 건강함을 강조한 Station입니다.</p>
							</li>
							<li>
								<p class="img"><img src="/pcPub/static/images/hotalParadise/img_onThePlate_station3.jpg" alt="" /></p>
								<h4>Euro Bread &amp; Cafe Station</h4>
								<p class="text">바게트(Baguette), 치아바타(Ciabatta), 스콘(Scone) 등의 Traditional Euro Bread와 함께 바리스타가 직접 뽑은 커피의 맛과 향을 경험할 수 있는 Station으로 유럽의 향을 느낄 수 있습니다.</p>
							</li>
							<li>
								<p class="img"><img src="/pcPub/static/images/hotalParadise/img_onThePlate_station4.jpg" alt="" /></p>
								<h4>Cantonese Station </h4>
								<p class="text">다양한 해산물과 육류로 구성된 광동 요리 중심의 Station 입니다.</p>
							</li>
							<li>
								<p class="img"><img src="/pcPub/static/images/hotalParadise/img_onThePlate_station5.jpg" alt="" /></p>
								<h4>Mariage Station</h4>
								<p class="text">각각의 Station과 조화를 이루는 시즌 별 특별 음료가 제공되는 Station으로, 매 시즌 색다른 분위기를 느끼실 수 있습니다.</p>
							</li>
						</ul>
					</div>
					<div class="btnArrow">
