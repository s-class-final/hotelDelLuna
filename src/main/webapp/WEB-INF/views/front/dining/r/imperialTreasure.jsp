		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/imperialTreasure/img_imperialTreasure1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/imperialTreasure/img_imperialTreasure2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/imperialTreasure/img_imperialTreasure3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/imperialTreasure/img_imperialTreasure4.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailInfo">
				...
				<div class="brandIntroduce">
					<h4>임페리얼 트레져</h4>
					<p class="text">Imperial Treasure는 2004년 싱가폴에서 출발하였으며 업계 최고의 쉐프와 베테랑 스태프를 갖춘 최고급 Fine Dining Cuisine 입니다.<br />뛰어난 서비스와 명품 요리로 고객의 품격을 맞춘 아시아 최고의 정통 중국 요리를 선사합니다.</p>
					<p class="link"><a href="http://www.imperialtreasure.com/" target="_blank">임페리얼 트레져 홈페이지 바로가기</a></p>
					<div class="brandLogo"><img src="/pcPub/static/images/sample/img_brand_logo.jpg" alt="" /></div>
				</div>
			</div>
			<!-- //메뉴 소개 -->
		</div>
