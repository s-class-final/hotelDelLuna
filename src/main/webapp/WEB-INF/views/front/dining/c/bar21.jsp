		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/bar21/bar21_main1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/bar21/bar21_main2.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
            ...
            <div class="detailTextBox">
                <h2>Bar 21</h2>
                <p class="subTit">카지노를 한층 더 다이내믹하게 즐길 수 있는 카지노 엔터테인먼트바</p>
                <p class="text">바21에서는 연중 색다른 이벤트와 공연이 펼쳐집니다. 매시간이 즐거운 바21에서 60여가지의 주류와 스낵 메뉴를 즐겨보세요.</p>
                <p class="colorEmp pt15i">* Bar 21은 카지노 고객 전용 다이닝 시설입니다. </p>
            </div>
            ...
            <div class="cautionBox type2">
                <h2>안내사항</h2>
                <ul class="dotList">
                    <li>Bar 21은 카지노 고객 전용 다이닝 시설입니다.</li>
                </ul>
            </div>
        </div>
