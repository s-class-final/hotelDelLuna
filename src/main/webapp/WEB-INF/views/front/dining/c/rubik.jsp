		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/rubik/img_rubik1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/rubik/img_rubik2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/rubik/img_rubik4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/rubik/img_rubik6.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/rubik/img_rubik7.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/dining/rubik/img_rubik8.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
				...
				<div class="infoDetail">
					<dl>
						...
						<dd>
							...
							<a href="https://www.p-city.com/front/event/eventView?PAGE_NO=1&PAGE_SIZE=9&BLOCK_SIZE=10&SBU_CD=000002&P_SEQ=4416&EVT_TYPE=EVENT&SC_END=PRO&ORDER_COLUMN=" class="link" style="margin-left:0px;">+ 공연정보 보기</a>
