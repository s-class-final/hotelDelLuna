		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_junior_suite1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_junior_suite2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_junior_suite3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_junior_suite4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_junior_suite5.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_junior_suite6.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_junior_suite7.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_junior_suite8.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
				<h2>JUNIOR SUITE</h2>
				<p class="subTit">고급스러운 색채와 감각적인 분위기를 지닌 격이 다른 럭셔리한 공간, 주니어 스위트</p>
				<p class="text">고급스러운 소재와 컬러에 포인트를 주어 우아한 멋스러움이 배어있는 주니어 스위트는 단 3개밖에 없는 특별한 객실입니다. <br />180평방미터의 넓은 공간에 두 개의 독립된 침실, 거실, 회의 공간 등을 갖추고 있어 다양한 목적별 활용이 가능하며, 24시간 이용 가능한 룸서비스와 객실 내 다양한 편의시설은 더 편안한 휴식 시간을 선사할 것입니다. </p>
				<div class="btnGroup">
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width:864px;">
		...
		<div class="mapPop tc">
			<div class="tapView" style="display:block;">
				<img src="resources/pcPub/static/images/room/suite/img_junior_suite_map1.jpg" alt="" />
			</div>
		</div>
