		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite5.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite6.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite7.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite8.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite9.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite10.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_deluxe_suite11.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
				...
				<p class="text">예술적인 감각에 럭셔리한 감성과 격조를 더한 디럭스 스위트는 2개의 침실, 거실, 집무실, 응접실, 다이닝 공간, 회의실 등 세계 최고 VIP만을 위한 모든 시설을 갖추고 있습니다. <br />디럭스 스위트 투숙 고객의 편의를 위하여 객실 내 다양한 어메니티를 구비하고 있으며, 24시간 룸서비스는 물론 디럭스 스위트 투숙 고객만을 위한 버틀러 서비스가 제공됩니다. </p>
				<div class="btnGroup">
					...
					<dl class="type2">
						...
						<dd>
							<ul class="dotList type2">
								<li>무료 WIFI</li>
								<li>86인치 FULL HD TV(거실)</li>
								<li>55인치 FULL HD TV(침실)</li>
								<li>위성 TV 63개 채널</li>
								<li>와인셀러</li>
								<li>스탠드형 오디오 </li>
								<li>개인용 금고</li>
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width:864px;">
		...
		<div class="mapPop tc">
			<div class="tapView" style="display:block;">
				<img src="resources/pcPub/static/images/room/suite/img_deluxe_suite_map1.jpg" alt="" />
			</div>
		</div>
