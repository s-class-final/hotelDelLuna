		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite5.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite6.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite7.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite8.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
				<h2>GRAND DELUXE SUITE</h2>
				<p class="subTit">세계 최고 VIP만을 위한 그랜드 디럭스 스위트</p>
				<p class="text">전용 POOL을 보유한 그랜드 디럭스 스위트는 마치 먼 휴양지에 와 있는 듯한 이국적인 분위기를 느끼게 해줍니다. <br />별관에 위치하여 독립적인 공간에서의 프라이빗한 휴식을 즐길 수 있으며, 객실 내 고급 편의 시설과 그랜드 디럭스 스위트 전용으로 제공되는 서비스는 단순한 휴식을 넘어 완벽한 휴양을 제공할 것입니다. </p>
				<div class="btnGroup">
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width:864px;">
		...
		<div class="mapPop tc">
			<div class="tapView" style="display:block;">
				<img src="resources/pcPub/static/images/room/suite/img_grand_deluxe_suite_map1.jpg" alt="" />
			</div>
		</div>
