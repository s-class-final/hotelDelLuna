	...
	<div class="hotelParadiseWrap pb0">
		<div class="innerBox">
			...
			<div class="detailTextBox">
				<h2>DELUXE</h2>
				<p class="subTit">편안한 분위기의 침실과 우아한 감성의 거실이 분리되어 독립적 공간 활용이 매력적인 디럭스 룸</p>
				<p class="text">우아한 감성을 바탕으로 편안하게 꾸며진 디럭스 룸은 거실과 침실을 분리한 설계로, 특히 여유로운 휴식 공간을 원하는 가족단위 고객이 선호하는 객실입니다. <br />68평방미터의 객실 공간은 Full HD TV, 캡슐 커피머신, 다양한 어메니티를 갖추고 있으며, 무료 와이파이 서비스는 호텔 투숙을 더욱 편안하게 만들어 줄 것입니다. </p>
				<div class="btnGroup">
