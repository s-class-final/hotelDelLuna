		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe5.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe6.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe7.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe8.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width:864px;">
		...
		<div class="mapPop tc">
			...
			<div class="tapView" style="display:block;">
				<img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe_map1.jpg" alt="" />
			</div>
			<div class="tapView">
				<img src="resources/pcPub/static/images/room/deluxe/img_grand_deluxe_map2.jpg" alt="" />
			</div>
		</div>
