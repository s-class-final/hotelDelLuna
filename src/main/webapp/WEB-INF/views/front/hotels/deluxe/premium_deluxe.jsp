		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_premium_deluxe1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_premium_deluxe2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_premium_deluxe3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_premium_deluxe4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_premium_deluxe5.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/deluxe/img_premium_deluxe6.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
				...
				<p class="subTit">클래식한 감성과 이국적인 신비로움이 가득한 프리미엄 디럭스</p>
				<p class="text">프리미엄 디럭스는 클래식한 감성을 바탕으로 고급스럽게 꾸며진 거실과 침실, 그리고 비즈니스를 위한 독립적인 집무실을 갖추고 있습니다. <br />135평방미터의 객실 공간은 Full HD TV, 캡슐 커피머신, 다양한 어메니티를 갖추고 있으며, 무료 와이파이 서비스는 호텔 투숙을 더욱 편안하게 만들어 줄 것입니다. </p>
				<div class="btnGroup">
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width:864px;">
		...
		<div class="mapPop tc">
			<div class="tapView" style="display:block;">
				<img src="resources/pcPub/static/images/room/deluxe/img_premium_deluxe_map1.jpg" alt="" />
			</div>
		</div>
