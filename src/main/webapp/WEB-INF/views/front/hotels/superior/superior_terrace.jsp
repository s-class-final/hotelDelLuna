		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/superior/img_superior_terrace1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/superior/img_superior_terrace2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/superior/img_superior_terrace3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/superior/img_superior_terrace4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/room/superior/img_superior_terrace5.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
				<h2>SUPERIOR TERRACE</h2>
				<p class="subTit">한층 여유로운 공간과 세련된 인테리어가 어우러진 슈페리어 테라스</p>
				<p class="text">우아한 카펫과 원목가구의 조화로움이 돋보이는 슈페리어 테라스는 54평방미터의 공간으로 꾸며져 있어, 한층 더 여유로운 시간을 제공합니다. <br />룸서비스 이용은 24시간 가능하며, 객실 내 캡슐 커피머신과 와이파이 서비스는 무료로 이용하실 수 있습니다.</p>
				<div class="btnGroup">
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width:864px;">
		...
		<div class="mapPop tc">
			...
			<div class="tapView" style="display:block;">
				<img src="resources/pcPub/static/images/room/superior/img_superior_terrace_map1.jpg" alt="" />
			</div>
			<div class="tapView">
				<img src="resources/pcPub/static/images/room/superior/img_superior_terrace_map2.jpg" alt="" />
			</div>
		</div>
