		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities1/img_outdoorPool1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities1/img_outdoorPool2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities1/img_outdoorPool3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities1/img_outdoorPool4.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities1/img_outdoorPool5.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities1/img_outdoorPool6.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities1/img_outdoorPool7.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities1/img_outdoorPool8.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
				<h2>Outdoor Pool</h2>
				<p class="subTit">하늘과 마주한 로맨틱한 Outdoor Pool</p>
				<p class="text">이국적인 낮의 경관과 로맨틱한 밤 분위기를 동시에 만날 수 있는 야외수영장은 사계절 내내 아름다움을 자랑하는 호텔 델루나의 시그니처 스팟입니다.</p>
			...
			<div class="detailInfo">
				<h3>상세정보</h3>
				<div id="odpInfo" class="infoDetail">
					<dl>
						<dt>운영시간</dt>
						<dd>
							<!-- 2019.09.04 문구변경요청 [김병철] -->
							09:00 ~ 19:00 (점검시간 14:00 ~ 15:00)<br />
							<!-- //2019.09.04 문구변경요청 [김병철] -->
							<p style="line-height:1.3;"><span class="smallText spaceBullet">수영장 정비시간(14:00 ~ 15:00)에는 <br/>일부 풀 이용이 제한될 수 있습니다.</span></p>
							<p style="line-height:1.3;"><span class="smallText spaceBullet">시즌 별 세부 운영 시간은 상세운영시간 보기를 통해 확인하시기 바랍니다. </span></p>
					...
					<dl>
						...
						<dd>
							...
							<p style="line-height:1.3;"><span class="smallText spaceBullet">실내/외 수영장에 함께 적용되는 요금입니다.</span></p>
							<p style="line-height:1.3;"><span class="smallText spaceBullet">시즌 및 상품에 따라 상이할 수 있습니다 </span></p>
						</dd>
					</dl>
					<dl>
						<dt>위치</dt>
			...
			<div class="detailInfo cabanaTable">
				<h3>카바나 이용</h3>
				...
				<table class="priceList">
					...
					<thead>
						<tr>
							...
							<th scope="col" colspan="2" class="cabaOP">운영시간</th>
							<th scope="col" rowspan="2" class="cabaPr">금액</th>
							<th scope="col" rowspan="2">혜택</th>
						</tr>
						<tr>
							<th scope="col">주중(월~금)</th>
							<th scope="col">주말(토,일,공휴일)</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<td class="tbg" rowspan="3">트로피칼 (1F)<br /><br />루프탑 (2F)</td>
							<td>09:00 ~ 12:00</td>
							<td>09:00 ~ 12:00</td>
							<td>300,000 원</td>
							<td rowspan="6" style="text-align:left;">
								카바나 미니바 제공<br />: 맥주 2, 탄산 2, 물 2
								<br /><br />스낵바 식음료 주문 시, Delivery Service 제공
							</td>
						</tr>
						<tr>
							<td>12:00 ~ 15:00</td>
						...
						<tr>
							<td class="tbg" rowspan="3">VIP (2F)</td>
							<td>09:00 ~ 12:00</td>
							<td>09:00 ~ 12:00</td>
							<td>350,000 원</td>
						</tr>
				...
				<p class="smallText spaceBullet" style="color:#e66045; font-weight:bold;">여름성수기 기간(6/1~9/1)에는 주말 운영시간이 적용됩니다.</p>
				<p class="smallText spaceBullet">카바나 예약은 이용예정일 기준 14일 전부터 가능합니다.</p>
				<p class="smallText spaceBullet">예약 취소는 2일전까지 가능하며 1일전 취소 시 50%, 당일 취소 시 100%의 위약금이 부과됩니다.(No-Show 시 100% 위약금 적용)</p>
				<p class="smallText spaceBullet">상기 정책은 호텔 사정에 따라 변경될 수 있습니다.</p>
			</div>
			...
			<div class="cautionBox type2">
				...
				<ul class="dotList">
					...
					<li>기상 상황에 따라 야외 수영장 이용이 제한될 수 있습니다.</li>
