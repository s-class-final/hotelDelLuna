		...
		<div class="innerBox">
			...
			<section class="jsSwiperMotion">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities4/img_fitness1.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities4/img_fitness2.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities4/img_fitness3.jpg" alt="" /></p>
						</li>
						<li>
							<p class="img"><img src="resources/pcPub/static/images/facilities/facilities4/img_fitness4.jpg" alt="" /></p>
						</li>
					</ul>
				</div>
				<div class="btnArrow">
			...
			<div class="detailTextBox">
				<h2>FITNESS</h2>
				<p class="subTit">건강한 하루를 호텔에서도 유지할 수 있게 도와주는 피트니스클럽</p>
				<p class="text">쾌적한 환경과 최신 장비로 구성된 피트니스센터는 단순한 체력관리뿐만 아니라 일상의 밸런스를 디자인 할 수 있도록 전문적인 트레이너와 프로그램을 운영하고 있습니다.</p>
			...
			<div class="cautionBox type2">
				...
				<ul class="dotList">
					...
					<li>Fitness는 17세(고등학생) 이상 고객에 한해 입장 가능합니다.</li>
					<li>운동복, 운동화, 양말, 웨이트 장갑, 이어폰 대여 서비스 가능합니다</li>
				</ul>
			</div>
		</div>
