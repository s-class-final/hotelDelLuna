...
<body>
	...
	<div class="hotelParadiseWrap">
		<div class="innerBox">
			...
			<div class="descBox">
				<div class="imageWrap"><img src="resources/pcPub/static/images/facilities/facilities1.jpg" alt=""></div>
				<div class="text">
			...
			<div class="descBox">
				<div class="imageWrap"><img src="resources/pcPub/static/images/facilities/facilities2.jpg" alt=""></div>
				<div class="text">
			...
			<div class="descBox">
				<div class="imageWrap"><img src="resources/pcPub/static/images/facilities/facilities3.jpg" alt=""></div>
				<div class="text">
			...
			<div class="descBox">
				<div class="imageWrap"><img src="resources/pcPub/static/images/facilities/facilities4.jpg" alt=""></div>
				<div class="text">
			...
			<div class="descBox">
				<div class="imageWrap"><img src="resources/pcPub/static/images/facilities/facilities7.jpg" alt=""></div>
				<div class="text">
			...
			<div class="descBox">
				<div class="imageWrap"><img src="resources/pcPub/static/images/facilities/facilities8.jpg" alt=""></div>
				<div class="text">
