...
public class Reservation {
	...
	public Reservation(int res_no, int res_roomNo, String res_roomType, String res_userId, String res_userName,
			String res_breakfast, String res_dinner, String res_adult, String res_child, Date res_checkIn,
			Date res_checkOut, String res_status, String res_payStatus) {
		super();
		this.res_no = res_no;
	...
	public String toString() {
		return "Reservation [res_no=" + res_no + ", res_roomNo=" + res_roomNo + ", res_roomType=" + res_roomType
				...
				+ ", res_dinner=" + res_dinner + ", res_adult=" + res_adult + ", res_child=" + res_child
				+ ", res_checkIn=" + res_checkIn + ", res_checkOut=" + res_checkOut + ", res_status=" + res_status
				+ ", res_payStatus=" + res_payStatus + "]";
	}
